...
def calcular_peso_ideal():
    ...
    resp_h = (72.7 * altura) - 58
    resp_m = (62.1 * altura) - 44.7

    print(f'Seu peso ideal é {resp_m:.1f} kg, se você for mulher')
    print(f'Seu peso ideal é {resp_h:.1f} kg, se você for homem')
